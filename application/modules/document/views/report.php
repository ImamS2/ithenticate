		...
		<div id="sc2623" class="sc-view sc-pane sc-main" style="left: 0px; right: 0px; min-width: 200px; top: 0px; bottom: 0px; min-height: 200px">
			<div id="sc2626" class="sc-view" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
				...
				<div id="sc2661" class="sc-view infobar" style="left: 0px; right: 0px; min-width: 800px; top: 20px; height: 60px">
					<div id="sc2662" class="sc-view branding-view" style="left: 0px; width: 260px; top: 0px; bottom: 0px"><img src="./iThenticate Document Viewer report_files/ithenticate-logo.png" id="sc2663" class="sc-view sc-image-view sc-regular-size" style="left: 50%; width: 195px; margin-left: -98px; top: 10px; height: 33px"></div>
					<div id="sc2664" class="sc-view infobar-paper-info" style="left: 310px; right: 345px; top: 0px; height: 60px">
						<div id="sc2665" class="sc-view sc-label-view infobar-title sc-regular-size" style="left: 0px; right: 0px; top: 10px; height: 24px; text-align: center; font-weight: normal; text-align: center; font-weight: normal">PENGARUH INVESTASI, TRADE OPENNES DAN LABOR FORCE TERHADAP PERTUMBUHAN EKONOMI</div>
						<div id="sc2667" class="sc-view sc-label-view author sc-regular-size" style="left: 0px; right: 0px; top: 35px; bottom: 0px; text-align: center; font-weight: normal; text-align: center; font-weight: normal">by resty </div>
					</div>
					<div id="sc2670" class="sc-view report-filters-options" style="right: 101px; width: 150px; top: 0px; bottom: 0px">
						<div id="sc2671" class="sc-view sc-label-view sc-regular-size" style="left: 0px; right: 10px; top: 10px; height: 25px; text-align: right; font-weight: normal; text-align: right; font-weight: normal">Quotes Included</div>
						<div id="sc2674" class="sc-view sc-label-view sc-regular-size" style="left: 0px; right: 10px; top: 30px; height: 25px; text-align: right; font-weight: normal; text-align: right; font-weight: normal">Bibliography Included</div>
					</div>
					<div title="Percent of document text that matches to selected content repositories" id="sc2677" class="sc-view info-tile-view similarity-view" style="right: 0px; width: 100px; top: 0px; bottom: 0px">
						<div title="" id="sc2681" class="sc-view sc-label-view label top-label sc-regular-size" style="left: 0px; right: 0px; top: 0px; height: 20px; text-align: center; font-weight: normal; text-align: center; font-weight: normal"></div>
						<div id="sc2684" class="sc-view sc-label-view infobar-value sc-regular-size" style="left: 50%; width: 80px; margin-left: -40px; top: 14px; height: 30px; text-align: center; font-weight: normal; text-align: center; font-weight: normal">43%</div>
						<div title="" id="sc2686" class="sc-view sc-label-view label bottom-label sc-regular-size" style="left: 0px; right: 0px; bottom: 0px; height: 17px; text-align: center; font-weight: normal; text-align: center; font-weight: normal">Similar</div>
					</div>
				</div>
				<div id="sc2702" class="sc-view sc-split-view sc-horizontal" style="left: 0px; right: 0px; top: 81px; bottom: 0px">
							...
							<div id="sc2712" class="sc-view sc-container-view" style="left: 0px; right: 14px; top: 0px; bottom: 0px">
								<div id="sc2966" class="sc-view" style="left: 0px; top: 0px; height: 43273px; right: 0px">
									<a id="sc2969" class="sc-view download-container hidden" style="left: 0px; top: 7px; height: 50px; width: 860px">
										...
										<div class="download-filename ellipsis">Download submitted file: koreksi Resti Ayu Ningsih 4111601001...docx</div>
									</a>
									<div id="sc2974" class="sc-view simple-collection-view simple-list-view page-list-view" style="left: 0px; top: 0px; width: 860px; height: 43273px">
                                                    ...
                                                    <div class="glimpse-liner above-highlight" style=""><img class="resize-handle" src="./iThenticate Document Viewer report_files/resize_handle.gif">
                                                        <div class="header">
                                                            ...
                                                            <div class="source-tools">
                                                                <div class="source-link"></div><img class="close-button" src="./iThenticate Document Viewer report_files/icon_close.png" alt="Close Glimpse" title="Close Glimpse">
                                                                <div class="view-full-source"><a class="view-full-source-link clickable">Full Source View</a></div>
                                                            </div>
                                                            <div class="source-title">
                                                                <div class="title-link ellipsis"></div>
                                                            </div>
                                                        </div>
                                                        <div class="loading-image-container"><img class="loading-image" src="./iThenticate Document Viewer report_files/loading_spinner_32x32.gif"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="sc3116" class="sc-view loading-view page-loading-view hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px"><img src="data:image/gif;base64,R0lGODlhAQABAJAAAP///wAAACH5BAUQAAAALAAAAAABAAEAAAICBAEAOw==" id="sc3121" class="sc-view sc-image-view loading-image sc-regular-size" style="left: 50%; width: 32px; margin-left: -16px; top: 50%; height: 32px; margin-top: -16px">
                                            <div id="sc3122" class="sc-view sc-label-view loading-text sc-regular-size" style="left: 50%; width: 200px; margin-left: -95px; top: 50%; height: 32px; margin-top: 19px; text-align: center; font-weight: normal; text-align: center; font-weight: normal">Loading Page</div>
                                        </div>
                                    </div>
                                    <div id="sc2974-sc2988" class="sc-view page-view" style="left: 0px; width: 860px; top: 1244px; height: 1216px">
                                        <div id="sc3132" class="sc-view sc-image-view" style="left: 0px; right: 0px; top: 0px; height: 1216px"><img height="1216" width="860" src="./iThenticate Document Viewer report_files/image(1)"></div>
                                        ...
                                        <div id="sc3200" class="sc-view loading-view page-loading-view hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px"><img src="data:image/gif;base64,R0lGODlhAQABAJAAAP///wAAACH5BAUQAAAALAAAAAABAAEAAAICBAEAOw==" id="sc3204" class="sc-view sc-image-view loading-image sc-regular-size" style="left: 50%; width: 32px; margin-left: -16px; top: 50%; height: 32px; margin-top: -16px">
                    ...
                    <div id="sc2717" class="sc-view sc-toolbar-view paper-toolbar" style="left: 0px; right: 0px; bottom: 0px; height: 29px">
                        <div title="View information about this paper" alt="View information about this paper" role="button" id="sc2718" class="sc-view sc-button-view paper-info-button icon square sc-regular-size" style="left: 10px; width: 33px; top: 50%; height: 28px; margin-top: -14px"><span class="sc-button-inner" style="min-width:0px"><label class="sc-button-label ellipsis"><img src="./iThenticate Document Viewer report_files/footer-button-info.png" alt="" class="icon"></label></span></div>
                        <div title="Download PDF of current report view" alt="Download PDF of current report view" role="button" id="sc2721" class="sc-view sc-button-view footer-button-print icon square sc-regular-size" style="left: 55px; width: 40px; top: 50%; height: 28px; margin-top: -14px"><span class="sc-button-inner" style="min-width:35px"><label class="sc-button-label ellipsis"><img src="./iThenticate Document Viewer report_files/legacy-footer-button-print.png" alt="" class="icon"></label></span></div>
                        <div role="button" id="sc2724" class="sc-view sc-button-view footer-button-print-spinner disabled hidden icon square sc-regular-size" style="left: 55px; width: 40px; top: 50%; height: 28px; margin-top: -14px"><span class="sc-button-inner" style="min-width:35px"><label class="sc-button-label ellipsis"><img src="./iThenticate Document Viewer report_files/loading-spinner(1).gif" alt="" class="icon"></label></span></div>
                        <div id="sc2726" class="sc-view" style="right: 35px; width: 165px; top: 0px; bottom: 0px; transition: right 0.15s linear 0s;"><img src="./iThenticate Document Viewer report_files/zoom-out.png" id="sc2728" class="sc-view sc-image-view sc-regular-size" style="left: 0px; width: 17px; top: 50%; height: 17px; margin-top: -9px">
                            <div title="Change zoom level" id="sc2729" class="sc-view sc-slider-view sc-regular-size" style="left: 20px; right: 20px; top: 50%; height: 21px; margin-top: -11px"><span class="sc-inner"><span class="sc-leftcap"></span><span class="sc-rightcap"></span><img src="data:image/gif;base64,R0lGODlhAQABAJAAAP///wAAACH5BAUQAAAALAAAAAABAAEAAAICBAEAOw==" class="sc-handle" style="left: 25%;"></span></div><img src="./iThenticate Document Viewer report_files/zoom-in.png" id="sc2734" class="sc-view sc-image-view sc-regular-size" style="right: 0px; width: 17px; top: 50%; height: 17px; margin-top: -9px">
                        </div>
                        <div id="sc2736" class="sc-view sc-label-view sc-regular-size" style="left: NaNpx; right: 225px; top: 4px; height: 15px; text-align: left; font-weight: normal; text-align: left; font-weight: normal">Page: 1 of 35</div>
                        <div title="Hide sidebar" alt="Hide sidebar" role="button" id="sc2739" class="sc-view sc-button-view hide-sidebar square sc-regular-size" style="right: 0px; width: 12px; top: 0px; bottom: 0px"><span class="sc-button-inner" style="min-width:0px"><label class="sc-button-label ellipsis"></label></span></div>
                    </div>
                </div>
                    ...
                    <div id="sc2780" class="sc-view" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                        <div id="sc2781" class="sc-view or-full-source-view-sidebar hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                            <div id="sc2783" class="sc-view" style="left: 0px; right: 0px; top: 0px; height: 38px">
                                <div id="sc2784" class="sc-view sc-label-view sidebar-header sc-regular-size" style="left: 50%; width: 200px; margin-left: -100px; top: 0px; height: 38px; text-align: center; font-weight: normal">Full Source Text</div>
                                <div title="" alt="" role="button" id="sc2785" class="sc-view sc-button-view panel-button square sc-regular-size" style="right: 6px; width: 30px; top: 6px; height: 30px"><span class="sc-button-inner" style="min-width:px"><label class="sc-button-label ellipsis"></label></span></div>
                            </div>
                            <div id="sc2787" class="sc-view loading-view hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px"><img src="data:image/gif;base64,R0lGODlhAQABAJAAAP///wAAACH5BAUQAAAALAAAAAABAAEAAAICBAEAOw==" id="sc2789" class="sc-view sc-image-view loading-image sc-regular-size" style="left: 50%; width: 32px; margin-left: -16px; top: 50%; height: 32px; margin-top: -16px">
                                <div id="sc2790" class="sc-view sc-label-view loading-text sc-regular-size" style="left: 50%; width: 200px; margin-left: -95px; top: 50%; height: 32px; margin-top: 19px; text-align: center; font-weight: normal">Loading...</div>
                            </div>
                            <div id="sc2795" class="sc-view" style="left: 8px; right: 8px; top: 38px; bottom: 30px">
                                ...
                                <div id="sc2799" class="sc-view match-group-selector-view" style="left: 0px; right: 0px; top: 60px; height: 30px">
                                    <div role="button" id="sc2802" class="sc-view sc-button-view left-match square sc-regular-size" style="left: 0px; width: 30px; top: 1px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"></label></span></div>
                                    <div id="sc2804" class="sc-view sc-label-view match-instance-conroller-label sc-regular-size" style="left: 30px; right: 30px; top: 5px; bottom: 0px; text-align: center; font-weight: normal; text-align: center; font-weight: normal"></div>
                                    <div role="button" id="sc2808" class="sc-view sc-button-view right-match square sc-regular-size" style="right: 0px; width: 30px; top: 1px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"></label></span></div>
                                </div>
                                <div id="sc2810" class="sc-view sc-scroll-view sc-gray-border" style="left: 0px; right: 0px; top: 90px; bottom: 0px">
                                    ...
                                    <div id="sc2814" class="sc-view sc-container-view" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                                        <div id="sc2815" class="sc-view sc-label-view source-text-label sc-static-layout sc-regular-size" style="left: 0px; right: 0px; top: 0px; bottom: 0px; min-height: 100px; text-align: left; font-weight: normal"></div>
                                    </div>
                        ...
                        <div id="sc2821" class="sc-view sc-tab-view or-sidebar" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                                ...
                                <div id="sc2840" class="sc-view sc-container-view" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                                    <div id="sc2845" class="sc-view sc-container-view" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                                        <div id="sc2865" class="sc-view originality-cumulative-sidebar" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                                            <div id="sc2867" class="sc-view sc-label-view or-sidebar-header sc-regular-size" style="left: 0px; right: 0px; top: 0px; height: 38px; text-align: left; font-weight: normal">Match Overview</div>
                                            <div id="sc2868" class="sc-view sc-segmented-view mode-toggle square sc-regular-size" style="right: 0px; width: 70px; top: 8px; height: 30px; text-align: center"><a role="button" title="Match Overview" class="sc-segment sc-first-segment sel" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label">Match Overview</label></span></a><a role="button" title="All Sources" class="sc-segment sc-last-segment" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label">All Sources</label></span></a></div>
                                            <div id="sc2870" class="sc-view or-multi-color-highlighting-off" style="left: 0px; right: 0px; top: 38px; bottom: 0px">
                                                <div id="sc2874" class="sc-view match-group-selector-view" style="left: 0px; right: 0px; top: 0px; height: 30px">
                                                    <div role="button" id="sc2877" class="sc-view sc-button-view left-match disabled square sc-regular-size" style="left: 0px; width: 30px; top: 1px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"></label></span></div>
                                                    ...
                                                    <div role="button" id="sc2883" class="sc-view sc-button-view right-match disabled square sc-regular-size" style="right: 0px; width: 30px; top: 1px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"></label></span></div>
                                                </div>
                                                        ...
                                                        <div id="sc2889" class="sc-view" style="left: 0px; right: 0px; top: 0px; height: 5180px">
                                                            <div id="sc2890" class="sc-view hidden" style="left: 0px; right: 0px; top: 0px; height: 100px">
                                                                <div id="sc2893" class="sc-view sidebar-section-header" style="left: 0px; right: 0px; top: 0px; height: 18px">
                                                                    <div id="sc2894" class="sc-view sc-label-view sc-regular-size" style="left: 10px; right: 0px; top: 0px; bottom: 0px; text-align: left; font-weight: normal; text-align: left; font-weight: normal">Currently viewing standard sources</div>
                                                                </div>
                                                                <div id="sc2896" class="sc-view" style="left: 0px; right: 0px; top: 20px; height: 60px">
                                                                    <div title="Switch to the Originality Report with sources for the English translation of the paper" alt="Switch to the Originality Report with sources for the English translation of the paper" role="button" id="sc2897" class="sc-view sc-button-view panel-button large icon square sc-regular-size" style="left: 50%; width: 260px; margin-left: -130px; top: 15px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"><img src="./iThenticate Document Viewer report_files/en.png" alt="" class="icon">View English Sources (Beta)</label></span></div>
                                                                </div>
                                                ...
                                                <div id="sc2919" class="sc-view loading-view hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px"><img src="data:image/gif;base64,R0lGODlhAQABAJAAAP///wAAACH5BAUQAAAALAAAAAABAAEAAAICBAEAOw==" id="sc2921" class="sc-view sc-image-view loading-image sc-regular-size" style="left: 50%; width: 32px; margin-left: -16px; top: 50%; height: 32px; margin-top: -16px">
                                                ...
                                                <div id="sc2927" class="sc-view hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px">
                                                    <div id="sc2932" class="sc-view sc-label-view sc-regular-size" style="left: 0px; right: 0px; top: 50%; height: 35px; margin-top: -18px; text-align: center; font-weight: normal">There are no matching sources for this report.</div>
                                                </div>
                                            </div>
                                            <div id="sc2933" class="sc-view frozenView hidden" style="left: 0px; right: 0px; top: 0px; bottom: 0px; background-color: #AEAEAE">
                                                <div id="__sc2867" class="sc-view sc-label-view or-sidebar-header sc-regular-size" style="left: 0px; right: 0px; top: 0px; height: 38px; text-align: left; font-weight: normal">Match Overview</div>
                                                <div id="__sc2868" class="sc-view sc-segmented-view mode-toggle square sc-regular-size" style="right: 0px; width: 70px; top: 8px; height: 30px; text-align: center"><a role="button" title="Match Overview" class="sc-segment sc-first-segment" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label">Match Overview</label></span></a><a role="button" title="All Sources" class="sc-segment sc-last-segment" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label">All Sources</label></span></a></div>
                                                <div id="__sc2870" class="sc-view or-multi-color-highlighting-off" style="left: 0px; right: 0px; top: 38px; bottom: 0px">
                                                    <div id="__sc2874" class="sc-view match-group-selector-view" style="left: 0px; right: 0px; top: 0px; height: 30px">
                                                        <div role="button" id="__sc2877" class="sc-view sc-button-view left-match square sc-regular-size" style="left: 0px; width: 30px; top: 1px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"></label></span></div>
                                                        ...
                                                        <div role="button" id="__sc2883" class="sc-view sc-button-view right-match square sc-regular-size" style="right: 0px; width: 30px; top: 1px; height: 26px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis"></label></span></div>
                                                    </div>
                                                            ...
                                                            <div id="__sc2889" class="sc-view" style="left: 0px; right: 0px; top: 0px; height: 426px">
                                                                <div id="__sc2890" class="sc-view hidden" style="left: 0px; right: 0px; top: 0px; height: 100px">
                                                                    <div id="__sc2893" class="sc-view sidebar-section-header" style="left: 0px; right: 0px; top: 0px; height: 18px">
                                                                        <div id="__sc2894" class="sc-view sc-label-view sc-regular-size" style="left: 10px; right: 0px; top: 0px; bottom: 0px; text-align: left; font-weight: normal; text-align: left; font-weight: normal">Currently viewing standard sources</div>
                                                                    </div>
                                                    ...
                                                    <div id="__sc2919" class="sc-view loading-view" style="left: 0px; right: 0px; top: 0px; bottom: 0px"><img src="data:image/gif;base64,R0lGODlhAQABAJAAAP///wAAACH5BAUQAAAALAAAAAABAAEAAAICBAEAOw==" id="__sc2921" class="sc-view sc-image-view loading-image sc-regular-size" style="left: 50%; width: 32px; margin-left: -16px; top: 50%; height: 32px; margin-top: -16px">
                            ...
                            <div id="sc2832" class="sc-view sc-segmented-view sidebar-tabs square sc-regular-size" style="left: 0px; width: 125px; bottom: 0px; height: 30px; text-align: center"><a role="button" title="View sources" class="sc-segment sc-first-segment sel cumulative" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label"></label></span></a><a role="button" title="View/edit filters and settings" class="sc-segment sc-middle-segment filter-settings" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label"></label></span></a><a role="button" title="View/edit excluded sources" class="sc-segment sc-last-segment exclusion-list" style="display: inline-block"><span class="sc-button-inner"><label class="sc-button-label"></label></span></a></div>
                            <div title="Navigate to text-only Similarity Report" alt="Navigate to text-only Similarity Report" role="button" id="sc2834" class="sc-view sc-button-view olde-version square sc-regular-size" style="right: 30px; width: 130px; bottom: 0px; height: 24px; max-height: 30px"><span class="sc-button-inner" style="min-width:80px"><label class="sc-button-label ellipsis">Text-Only Report</label></span></div>
                        </div>
                    </div>
                </div>
            </div>
