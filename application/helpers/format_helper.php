...
if (! function_exists('format_currency'))
{
	function format_currency($angka)
	{
		if ($angka === '0' || $angka === 0) {
			...
			$currency = 'Rp '.format_ribuan($angka);
		}
		return $currency;
	}
}
...
if (! function_exists('format_ithenticate'))
{
	function format_ithenticate($date)
	{
...
if (! function_exists('jadi_digit'))
{
	function jadi_digit($digit,$number)
	{
...
{
	function format_tanggal_jam($date)
	{
